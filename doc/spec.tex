...
An effect signature $E$ has the form $\langle L_i : \tau_{i,1} \rightarrow
\tau_{i,2} \rangle$. Again, since there can be 0 or more items in the signature,
this allows for the empty effect signature.
